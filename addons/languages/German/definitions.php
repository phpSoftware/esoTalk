...
// This file is part of Forum. Please see the included license file for usage information.
...
$definitions["Unignore conversation"] = "Nicht mehr ignorieren";
$definitions["Ignore conversation"] = "Unterhaltung ignorieren";
$definitions["Choose a Channel"] = "W&auml;hlen Sie einen Kanal";
...
$definitions["A new version of esoTalk (%s) is available."] = "Eine neue Version (%s) ist verf&uuml;gbar.";
...
$definitions["If you run into any other problems or just want some help with the installation, feel free to ask for assistance at the <a href='%s'>support forum</a>."] = "Wenn Du Probleme oder Fragen bei der Installation hast, kannst Du im <a href='%s'>Support Forum</a> einfach um Hilfe bitten.";
$definitions["Install esoTalk"] = "Installiere Forum";
...
$definitions["You have no notifications"] = "Sie haben keie Nachrichten";
...
$definitions["Members who are part of this group can be listed by searching for the group name in the member list."] = "Mitglieder, die Teil dieser Gruppe sind, k&ouml;nnen durch eine Suche nach dem Gruppennamen in der Liste der Benutzer aufgef&uuml;hrt werden.";
...
$definitions["online"] = "online";
$definitions["Only allow members of this group to see who else is in it"] = "Nur die Mitglieder dieser Gruppe d&uuml;rfen  die restlichen Teilnehmen zu sehen.";
...
$definitions["Sort By"] = "Sortierung:";
...
$definitions["Upgrade esoTalk"] = "Forum aktualisieren";
$definitions["Use a background image"] = "Hintergrundbild benutzen";
$definitions["Use for mobile"] = "Mobile Version";
$definitions["Use friendly URLs"] = "Benutze freundliche URLs";
$definitions["Used to verify your account and subscribe to conversations"] = "Um den Zugang zu verifizieren und Kan&auml;le zu abonnieren";
...
$definitions["Welcome to esoTalk!"] = "Willkommen in Deiner Forum-Installation!";
...
$definitions["message.confirmLeave"] = "Woah, Du hast Deinen Entwurf nicht gespeichert! Sobald Du diese Seite verlässt, verlierst Du alle ggf. eingegebenen Daten. Ist das OK für Dich?";
$definitions["message.connectionError"] = "Das Forum konnte sich nicht mit dem MySQL-Server verbinden. Der Fehler war:<br/>%s";
...
$definitions["message.esoTalkAlreadyInstalled"] = "<strong>Das Forum ist schon installiert.</strong><br/><small>Um das Forum neu zu installieren, musst Du die <strong>config/config.php</strong> entfernen.</small>";
$definitions["message.esoTalkUpdateAvailable"] = "Eine neue Version, %s, ist verf&uuml;gbar.";
...
$definitions["message.fulltextKeywordWarning"] = "Beachten Sie das Suchbegriffe mit weniger als 4 Zeichen Länge bei der Suche nicht berücksichtigt werden.";
...
$definitions["message.greaterPHPVersionRequired"] = "Your server must have <strong>PHP 5.0.0 or greater</strong> installed to run forum.<br/><small>Please upgrade your PHP installation or request that your host or administrator upgrade the server.</small>";
...
$definitions["message.installerAdminHelp"] = "Das Forum braucht die folgenden Daten, um den Administrator-Zugang f&uuml;r das Forum anzulegen.";
$definitions["message.installerFilesNotWritable"] = "Script cannot write to the following files/folders: <strong>%s</strong>.<br/><small>To resolve this, you must navigate to these files/folders in your FTP client and <strong>chmod</strong> them to <strong>777</strong>.</small>";
$definitions["message.installerWelcome"] = "<p>Welcome to the installer! We need a few details from you so we can get your forum set up and ready to go.</p>\n<p>If you have any trouble, get help on the <a href='%s'>support forum</a>.</p>";
...
$definitions["message.noMembersOnline"] = "Derzeit sind keine Mitglieder online.";
$definitions["message.hidden"] = "unsichtbar";
$definitions["message.noNotifications"] = "Sie haben keine Benachrichtigungen.";
...
$definitions["message.noSearchResults"] = "Keine Unterhaltung gefunden, die Ihren Suchkriterien entspricht.";
...
$definitions["message.preInstallErrors"] = "The following errors were found with your setup. They must be resolved before you can continue the installation.";
$definitions["message.preInstallWarnings"] = "The following errors were found with your setup. You can continue the install without resolving them, but some functionality may be limited.";
$definitions["message.reduceNumberOfGambits"] = "Reduzieren Sie die Anzahl an Suchbegriffen um mehr Treffer zu erhalten.";
$definitions["message.registerGlobalsWarning"] = "PHP's <strong>register_globals</strong> setting is enabled.<br/><small>While script can run with this setting on, it is recommended that it be turned off to increase security and to prevent the script from having problems.</small>";
...
$definitions["message.safeModeWarning"] = "<strong>Safe mode</strong> is enabled.<br/><small>This could potentially cause problems, but you can still proceed if you cannot turn it off.</small>";
...
$definitions["message.tablePrefixConflict"] = "The installer has detected that there is another installation in the same MySQL database with the same table prefix.<br/>To overwrite this installation, click 'Install My Forum' again. <strong>All data will be lost.</strong><br/>If you wish to create another installation alongside the existing one, <strong>change the table prefix</strong>.";
...
$definitions["message.upgradeSuccessful"] = "Forum wurde erfolgreich aktualisiert.";
...
// GENERAL EMAIL TEXT - Text Inspirations you can find here: https://reallygoodemails.com/
$definitions["email.click"]                  = "Klick hier!";
$definitions["email.help"]                   = "Brauchst Du mehr Hilfe?";
$definitions["email.hint"]                   = "Wir sind hier, um Dir zu helfen";
$definitions["email.link"]                   = "Wenn die Schaltfläche oben nicht funktioniert, kopiere den folgenden Link und füge ihn in Deinen Browser ein:";
$definitions["email.quest"]                  = "Wenn Du Fragen hast, antworte einfach auf diese E-Mail - wir helfen Dir jederzeit gerne weiter.";
$definitions["email.sender"]                 = "Tschüss!,<br>Dein Admin";

// 146:/core/models/ETActivityModel.class.php
$definitions["email.header"]                 = "<p>Hallo %s!</p>";
$definitions["email.footer"]                 = "Sie können Ihre Maileinstellungen jederzeit ändern, indem Sie hier klicken:";

// 267:/core/controllers/ETUserController.class.php
$definitions["email.confirmEmail.subject"]   = "%1\$s, hast Du dich für unser Forum angemeldet?"; /* 1 REPLACMENT */
$definitions["email.confirmEmail.body"]      = "<p>Hallo, wir haben gerade eine Anfrage von Deiner E-Mail-Adresse erhalten, die andeutet, dass Du daran interessiert bis, in das '%1\$s'-Forum zu gelangen.</p>
                                                <p>Aber bevor Du dort loslegen kannst, bitten wir Dich zu bestätigen, dass du das auch wirklich möchtest.</p>
                                                <p>Also drück den großen roten Knopf, um das zu bestätigen. (<b>Wenn Du dich nicht angemeldet hast, kannst du diese E-Mail einfach ignorieren. Wir werden Dich nicht wieder belästigen.</b>) Danke im Voraus!</p>"; /* 1 REPLACMENT */

// 52:/core/controllers/admin/ETUnapprovedAdminController.class.php
$definitions["email.approved.subject"]       = "Danke für die Anmeldung %1\$s, Dein Konto wurde freigegeben."; /* 1 REPLACMENT */
$definitions["email.approved.body"]          = "<p>Danke, dass Du dich für %1\$s angemeldet hast!</p>
                                                <p>Wir begr&uuml;&szlig;en Dich in unserer Community.</p>
                                                <p>Dieses Forum ist immer offen für Ideen.</p>
                                                <p>Schick uns also eine E-Mail, wenn Du Vorschläge hast.</p>
                                                <p>Zuletzt sollten wir noch erwähnen, dass wir Spenden, ob groß oder klein, über PayPal (internmail@gmail.com) annehmen. (Die großen Spenden bekommen übrigens netten Vergünstigungen.)</p>
                                                <p>Klick auf den folgenden Button, um Dich einzuloggen und die Show zu starten.</p>"; /* 1 REPLACMENT */

// 376:/core/controllers/ETUserController.class.php
$definitions["email.forgotPassword.subject"] = "Hast du Dein Passwort vergessen %1\$s?"; /* 1 REPLACMENT */
$definitions["email.forgotPassword.body"]    = "<p>M&uuml;sst Du dein '%1\$s' Forum Passwort zur&uuml;cksetzen? Kein Problem!</p>
                                                <p>Klick einfach auf die Schaltfläche unten und es geht los.</p>
                                                <p><b>Wenn Du diese Anfrage nicht gestellt haast, ignorier bitte einfach diese E-Mail.</b></p>"; /* 1 REPLACMENT */

// 476:/core/models/ETActivityModel.class.php
$definitions["email.mention.subject"]        = "%1\$s hat Dich in einem Beitrag erw&auml;hnt."; /* 1 REPLACMENT */
$definitions["email.mention.body"]           = "<p><strong>%1\$s</strong> hat Dich im <strong>%2\$s</strong> Beitrag erw&auml;hnt.</p>
                                                <hr size='1'>%3\$s<hr size='1'>
                                                <p>Um den Beitrag im Kontext der Unterhaltung aufzurufen, klicke einfach auf die folgenden Schaltfl&auml;che.</p>"; /* 3 REPLACMENTS */
...
$definitions["email.privateAdd.body"]        = "<p>Du wurdest zu einer privaten Unterhaltung mit dem Titel <strong>%1\$s</strong>  hinzugef&uuml;gt.</p>
                                                <hr size='1'>%2\$s<hr size='1'>
                                                <p>Um die Unterhaltung aufzurufen, klicke einfach die folgende Schaltfl&auml;che.</p>"; /* 2 REPLACMENTS */

// 528:/core/models/ETActivityModel.class.php
$definitions["email.post.subject"]           = "Es gibt eine neue Antwort auf '%1\$s'"; /* 1 REPLACMENT */
$definitions["email.post.body"]              = "<p><strong>%1\$s</strong> hat auf eine Unterhaltung der Du folgst geantwortet: <strong>%2\$s</strong></p>
                                                <hr size='1'>%3\$s<hr size='1'>
                                                <p>Um den neuen Beitrag in der Unterhaltung aufzurufen, klicke einfach auf die folgende Schaltfl&auml;che.</p>"; /* 3 REPLACMENT */
