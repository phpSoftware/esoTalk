...
public function handler_conversationController_formatPostForTemplate($sender, &$formatted, $post, $conversation)
{
	...
	$likeText = isset(ET::$session->userId) ? T($liked ? "<span class='link-unlike'><i class='far fa-thumbs-down' title='I hate it!'></i></span>" : "<span class='link-like' title='I like it!'><i class='far fa-thumbs-up'></i></span>") : "";
