...
ET::$skinInfo["Default2"] = array(
	"name" => "Default2",
	"description" => "The default esoTalk skin.",
	"version" => ESOTALK_VERSION,
	"author" => "uabclst",
	"authorEmail" => "uabclst@gmail.com",
	"authorURL" => "",
	"license" => "GPLv2"
);

class ETSkin_Default2 extends ETSkin {
...
public function handler_init($sender)
{
	...
	if (!C("skin.Default2.primaryColor")) $this->writeColors("#364159");
}
...
{
	ET::writeConfig(array("skin.Default2.primaryColor" => $primary));
...
public function settings($sender)
{
	...
	$form->setValue("primaryColor", C("skin.Default2.primaryColor"));
