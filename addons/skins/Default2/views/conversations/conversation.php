...
echo "<span class='action'>".avatar(array(
	...
	sprintf(T("%s started the conversation %s."),
		"<span class='lastPostMember name'>".memberLink($conversation["startMemberId"], $conversation["startMember"])."</span>",
		"<a href='".URL($conversationURL."/unread")."' class='lastPostTime'>".smartTime($conversation["startTime"], true)."</a>"),
	"</span>";
?></div>
