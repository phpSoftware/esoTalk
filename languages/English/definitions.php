...
$definitions["A new version of esoTalk (%s) is available."] = "A new version of the script (%s) is available.";
...
$definitions["If you run into any other problems or just want some help with the installation, feel free to ask for assistance at the <a href='%s'>support forum</a>."] = "If you run into any other problems or just want some help with the installation, feel free to ask for assistance at the <a href='%s'>support forum</a>.";
$definitions["Install esoTalk"] = "Install";
...
$definitions["Upgrade esoTalk"] = "Upgrade";
...
$definitions["Used to verify your account and subscribe to conversations"] = "To verify account and subscribe to conversations";
...
$definitions["Welcome to esoTalk!"] = "Welcome!";
...
$definitions["message.connectionError"] = "The script could not connect to the MySQL server. The error returned was:<br/>%s";
...
$definitions["message.esoTalkAlreadyInstalled"] = "<strong>Forum is already installed.</strong> To reinstall, you must remove <code>config/config.php</code>.";
$definitions["message.esoTalkUpdateAvailable"] = "A new version %s, is now available.";
$definitions["message.esoTalkUpdateAvailableHelp"] = "It's recommended to always have the latest version installed to reduce security risk. And hey, there might be some cool new features!";
$definitions["message.esoTalkUpToDate"] = "Your version is up-to-date.";
$definitions["message.esoTalkUpToDateHelp"] = "";
$definitions["message.fatalError"] = "The Forum has encountered a fatal error.";
...
$definitions["message.greaterPHPVersionRequired"] = "<strong>Your server must have PHP %s or greater installed to run the script.</strong> Please upgrade your PHP installation or request that your host or administrator upgrade the server.";
...
$definitions["message.installerAdminHelp"] = "We will use the following information to set up your administrator account on your forum.";
$definitions["message.installerFilesNotWritable"] = "<strong>We cannot write to the following files/folders: %s.</strong> To resolve this, you must navigate to these files/folders in your FTP client and <code>chmod</code> them to <code>0777</code>.";
$definitions["message.installerWelcome"] = "Set up your fat-free forum but by filling out the form below.<br>If you have any trouble, get help on the <a href='%s' target='_blank'>website</a>.";
...
$definitions["message.hidden"] = "hidden";
...
$definitions["message.preInstallWarnings"] = "You can continue the install without resolving the following warnings, but some functionality may be limited.";
...
$definitions["message.registerGlobalsWarning"] = "<strong>PHP's register_globals setting is enabled.</strong> While the script can run with this setting on, it is recommended that it be turned off to increase security and to prevent you from having problems.";
...
$definitions["message.safeModeWarning"] = "<strong>Safe mode is enabled.</strong> This could potentially cause problems, but you can still proceed if you cannot turn it off.";
...
$definitions["message.tablePrefixConflict"] = "The installer has detected that there is another installation in the same MySQL database with the same table prefix.<br>• To overwrite this installation, click 'Install' again. <strong>All data will be lost.</strong><br>• To create a new installation alongside this one, change the table prefix.";
...
$definitions["message.upgradeSuccessful"] = "The Script was successfully upgraded.";
...
$definitions["email.click"]                  = "Click here!";
$definitions["email.help"]                   = "Need more help?";
$definitions["email.hint"]                   = "We’re here to help you out";
$definitions["email.link"]                   = "If the button above doesn't work, copy and paste the following link in your browser:";
