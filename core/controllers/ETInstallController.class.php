...
public function action_install()
{
	...
	if (C("esoTalk.urls.rewrite")) {
		// adilbo
		file_put_contents(PATH_ROOT."/.htaccess", "# Generated by /core/controllers/ETInstallController.class.php
<IfModule mod_rewrite.c>
RewriteEngine On
RewriteCond $1 !^antibot/
...
protected function fatalChecks()
{
	...
	// adilbo - https://github.com/esotalk/esoTalk/issues/473
